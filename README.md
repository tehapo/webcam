...
Webcam is an UI component add-on for Vaadin 7.
...
Official releases of this add-on are available at Vaadin Directory. For Maven instructions, download and reviews, go to http://vaadin.com/addon/webcam

## Building and running demo

git clone <url of the Webcam repository>
mvn clean install
cd demo
mvn jetty:run
...
Webcam JavaDoc is available online at <...>